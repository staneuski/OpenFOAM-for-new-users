#!/bin/bash
# Creates new OpenFOAM solver with new name by copying existing solver from OpenFOAM application directory 

# ----------------------------------- Data ------------------------------- #

donorDir="$FOAM_APP/solvers/basic/potentialFoam/" # directory to the copied/donor solver
